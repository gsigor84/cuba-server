...
{/* leg api */}  
 ...
 {exe.attributes[muscle].exe1?  
   ...
   <h3 className='title'>Back</h3>
       ...
       <div>  
          <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={b1}  target="_blank"> {exe.attributes[muscle].exe1}</a></span> </Breadcrumb.Item>
   ...
   <Breadcrumb.Item><span className='page_font'>weight: {exe.attributes[muscle].weight1}</span> </Breadcrumb.Item>
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={b2}  target="_blank"> {exe.attributes[muscle].exe2}</a></span> </Breadcrumb.Item>
   ...
   <Breadcrumb.Item><span className='page_font'>weight: {exe.attributes[muscle].weight2}</span> </Breadcrumb.Item>
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={b3}  target="_blank"> {exe.attributes[muscle].exe3}</a></span></Breadcrumb.Item>
 ...
 {exe.attributes[muscle].exe4 ? 
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={b4}  target="_blank"> {exe.attributes[muscle].exe4}</a></span></Breadcrumb.Item>
