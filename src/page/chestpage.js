...
if(exe.attributes[muscle].exe1 === 'Dip'){
  ...
  return(
   ...
   <h3 className='title'>Chest</h3>
       ...
       <div>  
          <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={c1}  target="_blank"> {exe.attributes[muscle].exe1}</a></span> </Breadcrumb.Item>
   ...
   <Breadcrumb.Item><span className='page_font'>weight: {exe.attributes[muscle].weight1}</span> </Breadcrumb.Item>
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={c2}  target="_blank"> {exe.attributes[muscle].exe2}</a></span> </Breadcrumb.Item>
   ...
   <Breadcrumb.Item><span className='page_font'>weight: {exe.attributes[muscle].weight2}</span> </Breadcrumb.Item>
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={c3}  target="_blank"> {exe.attributes[muscle].exe3}</a></span> </Breadcrumb.Item>
 ...
 {exe.attributes[muscle].exe4 ? 
     ...
     <Divider/>
     <Breadcrumb>
   <Breadcrumb.Item><span className='page_font'><a href={c4}  target="_blank"> {exe.attributes[muscle].exe4}</a></span> </Breadcrumb.Item>
